...
// Archery Range
const int archer = 4;
const int crossbowman = 24;
const int arbalester = 492;
const int skirmisher = 7;
const int elite-skirmisher = 6;
const int imperial-skirmisher = 1155;
const int cavalry-archer = 39;
const int heavy-cavalry-archer = 474;
const int hand-cannoneer = 5;
const int slinger = 185;
const int grenadier = 1911;
const int genitour = 1010;
const int elite-genitour = 1012;
...
const int man-at-arms = 75;
const int long-swordsman = 77;
const int two-handed-swordsman = 473;
const int champion = 567;
const int legionary = 1793;
const int spearman = 93;
const int pikeman = 358;
const int halberdier = 359;
...
const int light-cavalry = 546;
const int hussar = 441;
const int winged-hussar = 1707;
const int knight = 38;
const int cavalier = 283;
const int paladin = 569;
const int savar = 1814;
const int camel-scout = 1755;
const int camel-rider = 329;
const int heavy-camel-rider = 330;
const int imperial-camel-rider = 207;
const int battle-elephant = 1132;
const int elite-battle-elephant = 1134;
const int steppe-lancer = 1370;
const int elite-steppe-lancer = 1372;
const int hei-guang-cavalry = 1944;
const int heavy-hei-guang-cavalry = 1946;
const int shrivamsha-rider = 1751;
const int elite-shrivamsha-rider = 1753;
const int stable-tarkan = 886;
const int stable-elite-tarkan = 887;
const int xolotlWarrior = 1570;

// Siege Workshop
const int feudal-battering-ram = 1258;
const int battering-ram = 35;
const int capped-ram = 422;
const int siege-ram = 548;
const int armored-elephant = 1744;
const int siege-elephant = 1746;
const int mangonel = 280;
const int onager = 550;
const int siege-onager = 588;
const int rocketCart = 1904;
const int heavyRocketCart = 1907;
const int scorpion = 279;
const int heavy-scorpion = 542;
const int warChariot = 1962;
const int bombard-cannon = 36;
const int houfnice = 1709;
const int tractionTrebuchet = 1942;
const int mountedTrebuchet = 1923;
const int siegeTower = 1105;

// Monastery
const int monk = 125;               // also disable with Economy
const int missionary = 775;
const int warrior-priest = 1811;    // also disable with Economy

// Krepost
const int krepost-konnik = 1254;
const int elite-krepost-konnik = 1255;

// Donjon
const int donjon-serjeant = 1660;
const int elite-donjon-serjeant = 1661;
const int spearmanDonjon = 1786;
const int pikemanDonjon = 1787;
const int halberdierDonjon = 1788;

// Castle
const int trebuchet = 331;
const int petard = 440;
const int composite-bowman = 1800;
const int elite-composite-bowman = 1802;
const int jaguar-warrior = 725;
const int elite-jaguar-warrior = 726;
const int ratha = 1759;
const int elite-ratha = 1761;
const int camel-archer = 1007;
const int elite-camel-archer = 1009;
const int longbowman = 8;
const int elite-longbowman = 530;
const int hussite-wagon = 1704;
const int elite-hussite-wagon = 1706;
const int konnik = 1225;
const int elite-konnik = 1227;
const int coustillier = 1655;
const int elite-coustillier = 1657;
const int arambai = 1126;
const int elite-arambai = 1128;
const int cataphract = 40;
const int elite-cataphract = 553;
const int woad-raider = 232;
const int elite-woad-raider = 534;
const int chu-ko-nu = 73;
const int elite-chu-ko-nu = 559;
const int kipchak = 1231;
const int elite-kipchak = 1233;
const int urumi-swordsman = 1735;
const int elite-urumi-swordsman = 1737;
const int shotel-warrior = 1016;
const int elite-shotel-warrior = 1018;
const int throwing-axeman = 281;
const int elite-throwing-axeman = 531;
const int monaspa = 1803;
const int elite-monaspa = 1805;
const int huskarl = 41;
const int elite-huskarl = 555;
const int chakram-thrower = 1741;
const int elite-chakram-thrower =1743 ;
const int ghulam = 1747;
const int elite-ghulam = 1749;
const int tarkan = 755;
const int elite-tarkan = 757;
const int kamayuk = 879;
const int elite-kamayuk = 881;
const int elephant-archer = 873;
const int elite-elephant-archer = 875;
const int genoese-crossbowman = 866;
const int elite-genoese-crossbowman = 868;
const int samurai = 291;
const int elite-samurai = 560;
const int iron-pagoda = 1908;
const int elite-iron-pagoda = 1910;
const int liao-dao = 1920;
const int elite-liao-dao = 1922;
const int ballista-elephant = 1120;
const int elite-ballista-elephant = 1122;
const int war-wagon = 827;
const int elite-war-wagon = 829;
const int leitis = 1234;
const int elite-leitis = 1236;
const int magyar-huszar = 869;
const int elite-magyar-huszar = 871;
const int karambit-warrior = 1123;
const int elite-karambit-warrior = 1125;
const int gbeto = 1213;
const int elite-gbeto = 1215;
const int plumed-archer = 763;
const int elite-plumed-archer = 765;
const int mangudai = 11;
const int elite-mangudai = 561;
const int war-elephant = 239;
const int elite-war-elephant = 558;
const int obuch = 1701;
const int elite-obuch = 1703;
const int organ-gun = 1001;
const int elite-organ-gun = 1003;
const int centurion = 1790;
const int elite-centurion = 1792;
const int mameluke = 282;
const int elite-mameluke = 556;
const int white-feather-guard = 1959;
const int elite-white-feather-guard = 1961;
const int serjeant = 1658;
const int elite-serjeant = 1659;
const int boyar = 876;
const int elite-boyar = 878;
const int conquistador = 771;
const int elite-conquistador = 773;
const int keshik = 1228;
const int elite-keshik = 1230;
const int flaming-camel = 1263;
const int teutonic-knight = 25;
const int elite-teutonic-knight = 554;
const int janissary = 46;
const int elite-janissary = 557;
const int rattan-archer = 1129;
const int elite-rattan-archer = 1131;
const int berserk = 692;
const int elite-berserk = 694;
const int tiger-cavalry = 1949;
const int elite-tiger-cavalry = 1951;
...
const int galleon = 442;
const int fire-galley = 1103;
const int fire-ship = 529;
const int fast-fire-ship = 532;
const int dragonShip = 1302;
const int demo-raft = 1104;
const int demolition-ship = 527;
const int heavy-demolition-ship = 528;
const int cannon-galleon = 420;
const int elite-cannon-galleon = 691;
const int dromon = 1795;
const int louChuan = 1948;
const int thirisadai = 1750;
const int turtle-ship = 831;
const int elite-turtle-ship = 832;
const int caravel = 1004;
